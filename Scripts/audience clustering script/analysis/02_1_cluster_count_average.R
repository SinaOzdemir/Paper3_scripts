...
clustering_indices<- c("kl", "ch", "hartigan", "ccc", "scott", "marriot",
                       ...
                       "db", "silhouette", "duda", "pseudot2", "ratkowsky", "ball", "ptbiserial", "gap", "frey",
...
dist = "euclidean"
methd = "average"
for (i in 9:length(good_indices)) {
  ...
  if(inherits(possible_error,"error")){
    ...
    saveRDS(optimum_numbers,file = paste0(data_folder,"/optimum_cluster_number_average.RDS"))  
  }
